 ...
 * @ORM\Entity(repositoryClass="Ydle\Bundle\RoomBundle\Repository\RoomTypeRepository")
 */
class RoomType
{
    /**
     ...
     * Add rooms
     *
     * @param \Ydle\Bundle\RoomBundle\Entity\Room $rooms
     * @return RoomType
     */
    public function addRoom(\Ydle\Bundle\RoomBundle\Entity\Room $rooms)
    {
        $this->rooms[] = $rooms;
     ...
     * @param \Ydle\Bundle\RoomBundle\Entity\Room $rooms
     */
    public function removeRoom(\Ydle\Bundle\RoomBundle\Entity\Room $rooms)
    {
