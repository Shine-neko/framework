...
use Ydle\Bundle\SettingsBundle\Manager\RoomTypeManager;
...
{    
    ...
    public function __construct(\Ydle\Bundle\RoomBundle\Manager\RoomTypeManager $roomTypeManager, Container $container)
    {
