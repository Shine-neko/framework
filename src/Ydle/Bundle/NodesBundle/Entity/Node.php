 ...
 */
namespace Ydle\Bundle\NodesBundle\Entity;

use Doctrine\ORM\Mapping as ORM;
use Gedmo\Mapping\Annotation as Gedmo;
use Symfony\Component\Validator\Constraints as Assert;
use Ydle\Bundle\RoomBundle\Entity\Room;
use Ydle\Bundle\NodesBundle\Entity\NodeType;
use Ydle\Bundle\NodesBundle\Validator\Constraints as YdleNodesAssert;
 ...
 * @ORM\Table(name="node")
 * @UniqueEntity("code")
 * @ORM\Entity(repositoryClass="Ydle\Bundle\NodesBundle\Repository\NodeRepository")
 * @ORM\NamedQueries({
...
class Node
{
     ...
     * @var integer
     *
     * @ORM\ManyToOne(targetEntity="Ydle\Bundle\RoomBundle\Entity\Room", inversedBy="nodes")
     ...
     * Add Type
     * 
     * @param \Ydle\Bundle\NodesBundle\Entity\NodeType $type
     */
     ...
     * Get typeId
     *
     * @return Ydle\Bundle\RoomBundle\Entity\Room
     */
